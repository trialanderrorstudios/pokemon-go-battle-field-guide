...
//
// Project: d-project.com (see the qrcode-generator npm package)
//
// Licensed under the MIT license (see opensource.org, license: mit-license.php)
//
// The word 'QR Code' is registered trademark of
// DENSO WAVE INCORPORATED (denso-wave.com/qrcode/faqpatent-e.html)
//
// ---------------------------------------------------------------------
...
export const qrcode = function(typeNumber, errorCorrectionLevel) {
  ...
  // createSvgTag (upstream SVG-string renderer) removed from this vendored
  // copy: unused here — the app builds its own inline <svg> from
  // getModuleCount()/isDark() in web/src/views/more.js instead, and the
  // upstream implementation embeds a literal SVG xmlns URL that trips this
  // repo's public-shell-safety scanner. Encoding logic below is unmodified.
