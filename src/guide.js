...
export const GUIDE_COPY = Object.freeze({
  ...
  dex: Object.freeze({
    ...
    body: `A dex entry gathers a single Pokémon's gym defense verdict, raid attacker rank, PvP ranks, moves, evolution line, and roster status onto one page. Reached from search, a name link elsewhere in the app, or by tapping a Pokémon on the Living Dex grid in the Dex tab.`,
  }),
});
